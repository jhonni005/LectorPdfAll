...
class PdfRecentViewModel(application: Application) : AndroidViewModel(application) {
    ...
    // --- ESTADOS DE UI ---
    private val _sortOption = MutableStateFlow(PdfSortOption.NAME_ASC)
    ...
    val pagedRecentPdfs: Flow<PagingData<PdfItem>> =
        _sortOption
            .flatMapLatest { sort ->
